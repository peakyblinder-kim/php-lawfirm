<?php
include './opt/lampp/htdocs/kenya/login.php';
include 'config.php';
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        <li cTEMS | 1 Hour of Chill Songs | Afrobeats／R&B MUSIC PLAYLIST | Temslass="breadcrumb-item"><a href="index.php">Home</a></li>
      ...
      <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
            <div class="modal-body text-center">
               <img src="../asset/img/sent.$sql="SELECT * FROM member where mem_id=$loggedin_id";png" alt="" width="50" height="46">
